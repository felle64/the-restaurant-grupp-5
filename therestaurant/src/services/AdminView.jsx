...
export const AdminView = () => {
  ...
  function filterBookings(bookings, filterDate, filterTime) {
    ...
    return bookings.filter((booking) => {
      if (
        (filterDate && filterDate !== booking.date) ||
        (filterTime && filterTime !== booking.time)
      ) {
        return false;
      }
      return true;
        ...
        {bookingsToShow.map((booking, index) => (
          <div key={index} className="admin-view__booking">
            <div className="admin-view__booking-details">
              ...
              <p className="admin-view__booking-guests">
              ...
              <p className="admin-view__booking-time">
                Time: {booking.time}:00
              </p>
              <p className="admin-view__booking-restaurant-id">
            ...
            <div className="admin-view__booking-edit">
              <input
                ...
                className="admin-view__edit-input"
                onChange={(e) => setNewNumberOfGuest(e.target.value)}
              />
              <input
                type="text"
                placeholder="Name"
            ...
            <div className="admin-view__booking-remove">
              <button
                ...
                value={booking.id}
                className="admin-view__remove-button"
              >
                Remove
              </button>
            </div>
