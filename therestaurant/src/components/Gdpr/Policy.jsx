	...
	return (
		<div className='policy-wrapper'>
			<div className='policy'>
				<h1 className=''>Integritetspolicy</h1>

				<h4>
					Vi på East Harmony värdesätter din integritet och är engagerade i att
					skydda den. Denna integritetspolicy beskriver vilken information vi
					samlar in, hur vi använder den och vilka rättigheter du har.
				</h4>
				...
				<h3>3. Delning av din information</h3>
				<p>
					Vi delar inte din personliga information med tredje parter utan ditt
					uttryckliga samtycke, förutom när det är nödvändigt för att
					tillhandahålla tjänster eller utföra våra affärsförpliktelser. Vi kan
					även dela din information om vi är skyldiga att göra det enligt lag
					eller för att skydda våra rättigheter och egendom.
				</p>
